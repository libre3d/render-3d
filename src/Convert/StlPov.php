...
class StlPov extends Convert {
	...
	protected function parseBinary($handle) {
		...
		fwrite($incFile, "// Generated by Render-3d stl to pov converter on ".date(DATE_RFC2822)."\n");
	 ...
	 * @return string
	 */
	protected function writeTriangle ($t, $handle) {
		fwrite($handle, "  triangle{\n    <{$t[0][0]}, {$t[0][1]}, {$t[0][2]}>,\n    <{$t[1][0]}, {$t[1][1]}, {$t[1][2]}>,\n    <{$t[2][0]}, {$t[2][1]}, {$t[2][2]}>\n  }\n");
		$this->parseCords($t);
	}
